      ...
      //父注入器的引用
		...
		*******************************************************************************************/
		...
		public function injectInto(target:Object):void
		{
			...
			var injecteeDescription:InjecteeDescription=m_injecteeDescriptions[targetClass] || getInjectionPoints(targetClass);
		...
		*******************************************************************************************/
		...
		private function getConfigurationForRequest(clazz:Class, named:String, traverseAncestors:Boolean=true):InjectionConfig
		{
			...
			var config:InjectionConfig=m_mappings[requestName + '#' + named];
			if (!config && traverseAncestors && m_parentInjector && m_parentInjector.hasMapping(clazz, named))
			{
		...
		private function addParentInjectionPoints(description:XML, injectionPoints:Array):void
		{
			...
			var parentDescription:InjecteeDescription=m_injecteeDescriptions[parentClass] || getInjectionPoints(parentClass);
